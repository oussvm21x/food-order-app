  ...
  return (
    <>
      <div className="flex items-center justify-center flex-col bg-slate-100 py-16 my-4 rounded-lg">
        <h1 className="text-2xl text-center lg:text-5xl font-semibold mb-3">
          For better experience, Download
        </h1>
        <h1 className="text-3xl lg:text-5xl font-semibold">
          <span className="text-orange-500">Tomato </span>App
        </h1>
        <div className="flex justify-end items-end text-center mt-5 lg:gap-20 align-bottom">
          <Link to="/play-store" className="lg:w-48 w-36">
            <img src={assets.play_store} className="w-full h-full" />
          </Link>
          <Link to="/app-store" className="lg:w-48 w-36">
